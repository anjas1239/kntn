...
*/
const A187 = '🔰BOT 8 BIT🔰'; // JANGAN UBAH-UBAH INFO!!!
const instagram = 'ga ada'; // JANGAN UBAH-UBAH INFO!!!
const nomer = 'wa.me/6282131022499'; // JANGAN UBAH-UBAH INFO!!!
const aktif = 'Tergantung Jaringan'; // JANGAN UBAH-UBAH INFO!!!
const groupwhatsapp = 'ga ada'; // JANGAN UBAH-UBAH INFO!!!
const youtube = 'ga ada'; // JANGAN UBAH-UBAH INFO!!!
//A187ID
...
conn.sendMessage(id, ' _Waalaikumsalam, _Iyaa...ada yang bisa aku bantu? Ketik *#help/#menu* untuk melihat fitur aku_ ' ,MessageType.text);
}
else if (text == 'salam'){
conn.sendMessage(id, ' _Waalaikumsalam, _Iyaa...ada yang bisa aku bantu? Ketik *#help/#menu* untuk melihat fitur aku_ ' ,MessageType.text);
}
...
conn.sendMessage(id, ' _Iya... aku disini kak... ada yang bisa aku bantu? Ketik *#help/#menu* untuk melihat fitur aku_ ' ,MessageType.text);
}
else if (text == 'P'){
conn.sendMessage(id, ' _Iya... aku disini kak... ada yang bisa aku bantu? Ketik *#help/#menu* untuk melihat fitur aku_ ' ,MessageType.text);
}
...
conn.sendMessage(id, ' *Xont* ' ,MessageType.text);
}
else if (text == '#help'){
...
conn.sendMessage(id, ' *Creator Nekko wa.me/6282131022499* ' ,MessageType.text);
}
else if (text == 'Pagi'){
conn.sendMessage(id, ' _Pagi juga Kakak... ada yang bisa aku bantu? Ketik *#help/#menu* untuk melihat fitur aku_ ' ,MessageType.text);
}
else if (text == 'Siang'){
conn.sendMessage(id, ' _Siang juga Kakak... ada yang bisa aku bantu? Ketik *#help/#menu* untuk melihat fitur aku_ ' ,MessageType.text);
}
else if (text == 'Sore'){
conn.sendMessage(id, ' _Sore juga Kakak... ada yang bisa aku bantu? Ketik *#help/#menu* untuk melihat fitur aku_ ' ,MessageType.text);
}
else if (text == 'Malam'){
conn.sendMessage(id, ' _Malam juga Kakak... ada yang bisa aku bantu? Ketik *#help/#menu* untuk melihat fitur aku_ ' ,MessageType.text);
}
else if (text == 'ngentod'){
conn.sendMessage(id, 'Anjir toxic' ,MessageType.text);
}
else if (text == 'anjing'){
...
conn.sendMessage(id, ' _Iya sayang ada apa? ada yang bisa aku bantu? Ketik *#help/#menu* untuk melihat fitur aku_ ' ,MessageType.text);
}
