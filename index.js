...
const config = {
    ...
    nomer: 'wa.me/6282131022499',
    aktif: 'Tergantung sinyal',
    youtube: 'Ga ada',
    whatsapp: 'Ga ada',
...
client.on('qr', qr => {
   ...
   console.log(`[ ${time} ] Woi kntl, Scan kode qr mu cok!`)
})
...
client.on('message-status-update', json => {
   ...
   console.log(`[ ${time} ] => bot by ig: ga ada`)
})
   ...
   case 'bitly':
    ...
    case 'bucin':
     ...
     case 'cooltext':
           ...
           break
          case 'creator':
            client.sendContact(from, '6282131022499@c.us')
            break
      case 'tts':
